...
#              Added pydev annotations to hide PyLint warnings
...
def prevent_core_dump():
    ...
    try:
        ...
        # its current value
        core_limit_prev = resource.getrlimit(core_resource) #@UnusedVariable
    except ValueError, exc:  #@UnusedVariable
        error = DaemonOSEnvironmentError(
...
def detach_process_context():
    ...
    def fork_then_exit_parent(error_message):
        ...
        try:
            ...
            exc_errno = exc.errno       #@UnusedVariable
            exc_strerror = exc.strerror #@UnusedVariable
...
def is_socket(fd):
    ...
    try:
        _socket_type = file_socket.getsockopt(
