...
class DaemonRunner(object):
    ...
    def _usage_exit(self, argv):
        """ Emit a usage message, then exit.
            """
        progname = os.path.basename(argv[0]) #@UnusedVariable
        usage_exit_code = 2
        action_usage = "|".join(self.action_funcs.keys())  #@UnusedVariable
    ...
    def _terminate_daemon_process(self):
        ...
        except OSError, exc:  #@UnusedVariable
